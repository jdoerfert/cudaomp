//===- omp_math.h - Declarations of the math API for all targets -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// Math function implementations for all supported targets.
//
//===----------------------------------------------------------------------===//

#ifndef LIBOMPTARGET_DEVICERTL_MATH_H
#define LIBOMPTARGET_DEVICERTL_MATH_H
